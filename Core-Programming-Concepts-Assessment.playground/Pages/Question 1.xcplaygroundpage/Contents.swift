...
let temputureInCelsius : Double = 20
let  temputureInFahrenheit = temputureInCelsius * 9 / 5 + 32
print("A temperature in degrees Celsius of \(temputureInCelsius) is equal to \(temputureInFahrenheit) in degrees Fahrenheit.")
